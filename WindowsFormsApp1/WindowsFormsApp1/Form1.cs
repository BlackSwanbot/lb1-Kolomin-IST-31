...
namespace WindowsFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        Dictionary<char, string> charToCP866 = new Dictionary<char, string>()
        {
            ...
            {'Р', "0x90"}, {'С', "0x91"}, {'Т', "0x92"}, {'У', "0x93"}, {'Ф', "0x94"}, {'Х', "0x95"}, {'Ч', "0x97"}, {'/', "0x2F"},
            ...
            {'y', "0x79"}, {'z', "0x7A"}, { '-', "0x96"}, {'8', "0x38"}, {'6', "0x36"}   
        };
        ...
        Dictionary<string, char> CP866ToChar = new Dictionary<string, char>()
        {
            ...
            { "0x90", 'Р' }, { "0x91", 'С' }, { "0x92", 'Т' }, { "0x93", 'У' }, { "0x94", 'Ф' }, { "0x95", 'Х' }, { "0x97", 'Ч' }, { "0x2F", '/' },
            ...
            { "0x79", 'y' }, { "0x7A", 'z' }, { "0x96", '-' }, { "0x38", '8' }, { "0x36", '6' }
        };
